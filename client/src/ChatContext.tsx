          ...
          for (const event of events) {
            ...
            try {
              ...
              if (jsonData.type === 'start') {
                ...
                setMessages(prev => 
                  prev.map(msg => 
                    msg.id === tempAiMessage.id 
                      ? { ...msg, message: msg.message + (jsonData.content || '') } 
                      : msg
                  )
                );
                ...
                setMessages(prev => 
                  prev.map(msg => 
                    msg.id === tempAiMessage.id 
                      ? { 
                          ...msg, 
                          message: jsonData.content || msg.message,
                          // Store the sources in the message for display
                ...
                // Stream completed
                // We may want to refresh the session data here
                refreshSession();
              }
            } catch (e) {
